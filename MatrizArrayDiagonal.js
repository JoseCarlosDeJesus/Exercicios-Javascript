...
<html>
  <head>
    <title>MatrizDiagonalSomatorio</title>
    <script>
    <script>
      var resultado = '';
      var posicao   = 0;
      ...
      for (el in meuArray) {
        itemEncontrado = meuArray[el][posicao] + meuArray[el][posicao + 1];
        somatorio += parseInt(itemEncontrado)
        document.write(itemEncontrado + ' - ' + somatorio +'<br>');
        posicao += 3;
      };
      </script>
    </script>
